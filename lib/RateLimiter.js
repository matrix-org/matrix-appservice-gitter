...
/**
 * Returns the current deferral delay time in miliseconds, or zero if there is
 * nothing currently waiting
 */
RateLimiter.prototype.getCurrentDelay = function() {
    var delay = this._nextNotBefore - Date.now();
