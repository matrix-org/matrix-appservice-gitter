...
function GitterUser(bridge, remoteUserModel) {
    ...
    this._gitter_id = remoteUserModel.getId();
    this._username = remoteUserModel.get("username");
    this._display_name = remoteUserModel.get("display_name");
    this._avatar_url = remoteUserModel.get("avatar_url");
