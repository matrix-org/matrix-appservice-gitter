...
const log = require("./Logging.js").Get("GitterUser");
...
GitterUser.prototype.updateAvatar = function(url) {
    ...
    log.debug("Updating " + this.gitterUsername() + " avatar image from " + url);
...
GitterUser.prototype.updatePresence = function(present) {
    ...
    if (present) {
        ...
        log.debug("ONLINE " + this.gitterUsername());
        ...
        this._presenceDelayId = setTimeout(() => {
            ...
            log.debug("OFFLINE " + this.gitterUsername());
