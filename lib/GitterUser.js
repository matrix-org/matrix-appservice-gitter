...
GitterUser.prototype.getIntent = function() {
    return this._intent = this._intent || (
        // TODO(paul): I'm not sure this is the right place for case-folding
        //   logic, but it'll do for now here.
        this._bridge.getIntentFromLocalpart('gitter_' +
            this.gitterUsername().toLowerCase())
    );
};
