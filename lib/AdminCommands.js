...
adminCommands.list = new AdminCommand({
    ...
    opts: {
        failed: {
            description: "list only failed rooms",
            aliases: ['F'],
            boolean: true,
        },
    },
...
adminCommands.link = new AdminCommand({
    ...
    opts: {
        ...
        gitter_name: {
            description: "gitter room name",
        },
    },
    args: ["matrix_id", "gitter_name"],
    func: function(main, opts, args, respond) {
        return main.actionLink(opts.matrix_id, opts.gitter_name).then(
            ()    => { respond("Linked"); },
...
adminCommands.unlink = new AdminCommand({
    ...
    opts: {
        id: {
            description: "matrix or gitter room ID or name",
        },
    },
    args: ["id"],
    func: function(main, opts, args, respond) {
...
adminCommands.mkportal = new AdminCommand({
    ...
    args: ["gitter_name"],
    func: function(main, opts, args, respond) {
        return main.actionMakePortal(opts.gitter_name).then(
...
adminCommands.set_access_token = new AdminCommand({
    ...
    opts: {
        ...
        access_token: {
            description: "raw access token as a string",
        },
    },
...
adminCommands.sync_users = new AdminCommand({
    ...
    opts: {
        ...
        join: {
            description: "include joins",
            aliases: ['j'],
            boolean: true,
        },
        leave: {
            description: "include leaves",
            aliases: ['l'],
            boolean: true,
        },
        all: {
