...
function MatrixGitterBridge(config) {
    ...
    if (config.enable_metrics) {
        ...
        metrics.addGauge("rooms", "current count of mapped rooms",
            (gauge) => {
        ...
        metrics.addGauge("users", "current count of mapped users",
            (gauge) => {
                gauge.set({side: "remote"},
        ...
        metrics.addCounter("received_messages", "count of received messages");
        metrics.addCounter("sent_messages", "count of sent messages");
    }
}
