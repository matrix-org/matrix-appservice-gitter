...
//   URL.
MatrixGitterBridge.prototype.getUrlForMxc = function(mxc_url, opts) {
    var kind = (opts && opts.thumb) ? "thumbnail" : "download"

    var url = this.homeserver + "/_matrix/media/v1/" + kind + "/" +
        mxc_url.substring("mxc://".length);

    if (opts && opts.thumb) {
        url += "?width=16&height=16";
    }
