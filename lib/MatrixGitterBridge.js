...
MatrixGitterBridge.prototype.getBotUserId = function() {
    return this._bridge.getBot().getUserId();
};
...
MatrixGitterBridge.prototype.getLinkByMatrixId = function(matrixId) {
    ...
    var room = this.getBridgedRoomByMatrixId(matrixId);
    ...
    if (room) {
        ...
        return new Promise.reject(new Error("Link not found"));
    }
};
