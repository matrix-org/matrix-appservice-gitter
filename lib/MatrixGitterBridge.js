...
MatrixGitterBridge.prototype.onUserMappingQuery = function(fields) {
    var username;
    var userid;
    ...
    // TODO(paul): reverse MXID->gitter lookup
        ...
        return Promise.reject("Require a 'usernanme' parameter'");
    }
...
MatrixGitterBridge.prototype.run = function(port) {
    ...
    app.get("/_matrix/app/:ver/thirdparty/user/:protocol", (req, res) => {
        ...
        this.onUserMappingQuery(req.query).then(
