...
BridgedRoom.prototype.linkMatrixRoom = function(matrixRoomModel) {
    this._matrixRoomIds.push(matrixRoomModel.getId());
};
...
BridgedRoom.prototype.unlinkMatrixRoom = function(matrixRoomModel) {
    this._matrixRoomIds = this._matrixRoomIds.filter((id) =>
        id !== matrixRoomModel.getId()
    );

    if (this._matrixRoomIds.length) return Promise.resolve();

    return this.stopAndLeave();
};

BridgedRoom.prototype.getMatrixRoomIds = function() {
    return this._matrixRoomIds;
};
...
BridgedRoom.prototype.onGitterMessage = function(message) {
    ...
    this._bridge.mapGitterUser(fromUser).then((user) => {
        ...
        this._matrixRoomIds.forEach((matrixRoomId) => {
