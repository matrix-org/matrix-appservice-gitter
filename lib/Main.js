    ...
    var bridge = new Bridge({
        ...
        controller: {
            ...
            onEvent: (req, context) => {
                ...
                if (event.type === "m.room.member" && !isRemoteUser) {
...
Main.prototype.handleMatrixKickBan = async function(event) {
    ...
    if (membership === "leave" && event.state_key !== bridgeBot.getUserId()) {
        keyword = "kicked"
    ...
    await this._relayBotGitterGhost.send(rooms.gitterRoomName(), message);
