        ...
        controller: {
            ...
            onEvent: (req, context) => {
                ...
                if (!handled) {
                    ...
                    if (bridgedRoom === undefined) {
                        // this room either failed or is no longer bridged, let's leave it.
                        bridge.getIntent().kick(event.room_id, bridge.getBot().getUserId(), 'Room is not bridged.');
                    }
                    return;
                }
