...
Main.prototype.initialiseMetrics = function() {
    ...
    this._bridge.registerBridgeGauges(() => {
        ...
        return {
            ...
            // As a relaybot we don't create gitter-side ghosts
            remoteGhosts: 0,
...
Main.prototype.getOrCreateGitterGhost = function(user_id) {
    // TODO(paul): look up access_token for user_id and make a puppet ghost
    return Promise.resolve(this._relayBotGitterGhost);
};
